...
public class RegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        //[diganti dengan session manager di bawah]SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        ...
        try {
            ...
            synchronized (TAG) {
                //debug
                Log.d("debug sender id", "Sender : " + R.string.gcm_defaultSenderId);
                ...
                // [END get_token]
                Log.d(TAG, "GCM Registration Tokenn: " + token);
                Log.d(TAG, "GCM Instance ID : " + instanceID.getId());

                //Logging.toast(getApplicationContext(),"Instance ID : "+instanceID.getId(),2);
...
//                Log.i(TAG, "GCM Registration regid: " + regid);
        ...
        Intent registrationComplete = new Intent(StaticVar.REGISTRATION_COMPLETE);
     ...
     */
    private void sendRegistrationToServer(String token,SessionManager session) {
